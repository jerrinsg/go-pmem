...
const (
	...
	// During buildSSA, 1-> node is lhs of assignment op within txn() block
	// 2 -> node reads a value within txn() block. Useful when tracking reads in redo logging
	// 3 -> node known to be in pmem because it was created using pnew
)
