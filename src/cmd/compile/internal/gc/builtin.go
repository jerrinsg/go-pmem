...
func runtimeTypes() []*types.Type {
	...
	typs[94] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[32]), anonfield(typs[32]), anonfield(typs[32])}, []*Node{anonfield(typs[58])})
	typs[95] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[15]), anonfield(typs[15]), anonfield(typs[32])}, []*Node{anonfield(typs[58])})
