...
var runtimeDecls = [...]struct {
	...
	{"inpmem", funcTag, 114},
	{"getTxHandle", funcTag, 115},
	{"setTxHandle", funcTag, 116},
...
func runtimeTypes() []*types.Type {
	...
	typs[95] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[32]), anonfield(typs[32]), anonfield(typs[32])}, []*Node{anonfield(typs[53])})
	typs[96] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[15]), anonfield(typs[15]), anonfield(typs[32])}, []*Node{anonfield(typs[53])})
	...
	typs[114] = functype(nil, []*Node{anonfield(typs[47])}, []*Node{anonfield(typs[11])})
	typs[115] = functype(nil, nil, []*Node{anonfield(typs[53])})
	typs[116] = functype(nil, []*Node{anonfield(typs[53])}, nil)
	return typs[:]
}
