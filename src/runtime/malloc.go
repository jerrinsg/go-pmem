...
func largeAlloc(size uintptr, needzero bool, noscan bool, memtype int) *mspan {
	...
	mheap_.central[memtype][spc][s.typIndex].mcentral.fullSwept(mheap_.sweepgen).push(s)
	s.limit = s.base() + size
