...
func convT2E16(t *_type, val uint16) (e eface) {
	...
	if val == 0 {
		...
		x = mallocgc(2, t, doesntNeedZeroed, isNotPersistent)
		*(*uint16)(x) = val
	}
	e._type = t
	e.data = x
...
func convT2E32(t *_type, val uint32) (e eface) {
	...
	if val == 0 {
		...
		x = mallocgc(4, t, doesntNeedZeroed, isNotPersistent)
		*(*uint32)(x) = val
	}
	e._type = t
	e.data = x
...
func convT2E64(t *_type, val uint64) (e eface) {
	...
	if val == 0 {
		...
		x = mallocgc(8, t, doesntNeedZeroed, isNotPersistent)
		*(*uint64)(x) = val
	}
	e._type = t
	e.data = x
...
func convT2Estring(t *_type, val string) (e eface) {
	...
	if val == "" {
		...
		x = mallocgc(unsafe.Sizeof(val), t, needZeroed, isNotPersistent)
		*(*string)(x) = val
	}
	e._type = t
	e.data = x
